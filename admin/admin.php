                    ...
                    <nav class="navbar navbar-inverse">
                        <div class="container-fluid">
                          <ul class="nav navbar-nav">
                            ...
                            <li class="passive"><a href="/admin/adminlogin.php">Back</a></li>
                          </ul>
                        </div>
                        </nav>
...
echo '<br><center><span style="color: black; font-size: 20px;align:center;" class="p-3 mb-2 bg-warning text-dark">No search results found !</span><br><br></center>';
}}
		mysqli_close($con);
		?>
