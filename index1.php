...
<?php
function familyName($date) {  
  $dat = date('Y-m-d');    
    $conn=mysqli_connect('localhost', 'id16507289_mukund', 'STgm!j8SO]Atif6|', 'id16507289_bookings');
	 $query="select date from blacklist where date>=$dat;";
